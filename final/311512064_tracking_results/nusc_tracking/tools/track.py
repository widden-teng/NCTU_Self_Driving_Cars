...
class nusc_dataset:
    ...
    def lidar2world(self, objects, token, inverse=False):
        ...
        for object in objects:
            ...
            object['rotation'] = q_to_wxyz(
                R.from_matrix(new_trans[:3, :3]).as_quat())
...
def main() -> None:
    ...
    parser.add_argument("--detection_path", type=str,
                        default='data/detection_result.json')
    parser.add_argument("--frames_meta_path", type=str,
                        default='data/frames_meta.json')
    ...
    print("tracking results have {} frames".format(
        len(nusc_annos_trk["results"])))
